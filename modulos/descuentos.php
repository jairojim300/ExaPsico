...
<form id="form1" name="form1" method="post" action="" onsubmit="return validar_registro1(form1)" >
   <table width="248" align="center">
    <tr>
      <th height="56" colspan="3" scope="col"><span class="Estilo7">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="132" height="32">
          <param name="SRC" value="/rodar/imagen/cuadrecaja.swf" />
          <param name="BGCOLOR" value="" />
          <param name="movie" value="../imagen/cuadrecaja.swf" />
          <param name="quality" value="high" />
          <embed src="/rodar/imagen/cuadrecaja.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="132" height="32"></embed>
        </object>
      </span></th>
    </tr>
    ...
    <tr>
      <th scope="row"><div align="right" class="Estilo8"># Factura </div></th>
      <td colspan="2" bgcolor="#FFFFFF"><div align="left">
        <label>
        <input name="texfact" type="text" id="texfact" size="20" onFocus="siguienteCampo ='texvalor';" />
        </label>
      </div></td>
    </tr>
    <tr>
  ...
  <?php
		...
		if(isset($_REQUEST['btnregistrar']))
 		{
			...
			$num_fac=strtoupper($_POST['texfact']);
			$val_fac=$_POST['texvalor'];
			$descrip=$_POST['texdesc'];
			
		
							
				$buscar = consultar("select * from descuento where num_fac_des='$num_fac' and fecha_des='$fecha'");
				...
				else 
	{
		...
		$registrar="insert into descuento values('','$fecha','$num_fac','$val_fac','$descrip','Machala','$a225')";
						save($registrar);
