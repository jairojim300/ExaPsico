...
$buscar2 = consultar("select * from alum_renov where nu_cedula='$cedula'");
			...
			echo "<script language=\"javascript\">
			  		location=\"indexadmin.php?cont=13\";</script>";
									
					}
					
					
		$buscar12 = consultar("select * from examen where nu_cedula='$cedula' and fecha > '2018-01-01'");
					...
					{
							echo "<script LANGUAGE=\"JavaScript\">
								alert (\"Alumno no se realiza EXAMEN AUN.\");window.close();
								</script>";
...
$busqueda2 = consultar("select * from examen where nu_cedula='$cedula' and fecha > '2018-01-01'");
...
?>
  ...
  <tr>
    ...
    <th align="left" class="Estilo11" scope="row"><input name="txt_vis" type="text" class="Estilo40" id="txt_vis" value="<?=$fila2["tipo"]?>" size="15" readonly="readonly" /></th>
    ...
    <td width="34%" class="Estilo1"><span class="Estilo11">
      <input name="txt_vision2522" type="text" id="txt_vision2522" size="10" maxlength="10"  />
    </span></td>
    </tr>
  ...
  <table width="200" align="right">
    <tr>
      <th align="right" scope="col"><a href="/rodar/indexadmin.php?cont=13" class="Estilo27"><img src="/rodar2/imagen/eliminar.png" alt="aa" width="28" height="30" border="0" /></a></th>
    </tr>
  </table>
