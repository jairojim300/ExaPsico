...
<body>
	...
	$busqueda = consultar("select * from reprobado where fecha='$cedula' ");
  ...
  <table width="314" align="center">
    <tr>
      <th height="64" colspan="3" scope="col"><p class="Estilo11">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="281" height="42" title="reporte_repro">
          <param name="SRC" value="/rodar/imagen/reporte_repro.swf" />
          <param name="BGCOLOR" value="" />
          <param name="movie" value="../imagen/reporte diario psico.swf" />
          <param name="quality" value="high" />
          <embed src="/rodar/imagen/reporte_repro.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="281" height="42"></embed>
        </object>
        </p>      </th>
    </tr>
    <tr>
...
//    $cedula=$_POST["txt_fecha"];
		...
		$busqueda23 = consultar("select COUNT(*) from reprobado where date(fecha) BETWEEN '$fechaa' and '$cedula' ");
    ...
    <tr>
      ...
      <td><div align="right" class="Estilo23">$15</div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <th colspan="3" scope="row"><a href="modulos/detalle_desc_repro.php?v=<?=$fechaa?>&a=<?=$cedula?>" target="_blank">Ver Detalle </a></th>
    </tr>
